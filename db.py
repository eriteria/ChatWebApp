...
client = MongoClient("mongodb+srv://test:test@chatapp.q3zok.mongodb.net/ChatDB?retryWrites=true&w=majority")
...
def remove_room_memebers(room_id, usernames):
...
def get_messages(room_id, page=0):
    ...
    messages = list(Messages_collection.find({'room_id': room_id}).sort('_id', DESCENDING).limit(MAX_MESSAGE_FETCH_LIMIT).skip(offset))
